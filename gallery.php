...
<section class="my-5">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12">
            <img class="img-fluid pd-4 py-3 aboutimg" src="images/farm11.jpg" >
            </div>

            <div class="col-lg-4 col-md-4 col-12">
            <img class="img-fluid pd-4 py-3 aboutimg" src="images/farm12.jpg" >
            </div>

            <div class="col-lg-4 col-md-4 col-12">
            <img class="img-fluid pd-4 py-3 aboutimg" src="images/farm13.jpg" >
            </div>
