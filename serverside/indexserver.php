    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <a href="aboutserver.php" class="btn btn-success">Know More</a>
            </div>
    ...
    <div class="container">
                    ...
                    <img class="card-img-top" src="../images/moisture.jpg" alt="Card image"/>
                      <div class="card-body">
                         <h4 class="card-title text-center " >Moisture</h4>
                          ...
                          <center><a href="server_sensor_info/moistureserver.php" class="btn btn-primary">Know More</a></center>
                     </div>
                 </div>
              </div>
        ...
        <div class="col-lg-4 col-md-4 col-12">
                ...
                <div class="card-body">
                    ...
                    <center><a href="server_sensor_info/temperatureserver.php" class="btn btn-primary pull-right" >Know More</a> </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-4 col-12">
                ...
                <div class="card-body">
                    ...
                    <center><a href="server_sensor_info/sunlightserver.php" class="btn btn-primary">Know More</a></center>
                </div>
            </div>
        </div>
