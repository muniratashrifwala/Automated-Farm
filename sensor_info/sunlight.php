...
<div class="jumbotron">
  <h1>Sunlight Sensor</h1>
  <p>An easier way to keep a track of your farms</p>
</div>

<section class="my-5">
    <!-- <div class="py-5">
        <h2 class="text-center"> Sunlight </h2>
    </div> -->

    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <img src="../images/sunlight.jpg" class="img-fluid aboutimg">
            </div>
...
<section>
  <div>
  <center><a href="moisture.php" class="btn btn-success smoothscroll"> Moisture</a>
 &nbsp; &nbsp; &nbsp;
 <a href="temperature.php" class="btn btn-success smoothscroll"> Temperature</a></center>
</div>
<div>
  <p>&nbsp;</p>
</div>
