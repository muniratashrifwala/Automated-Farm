...
<div class="jumbotron">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
        <a class="nav-link" href="moisture.php">Moisture</a>
      </li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <img src="../images/temperature.jpg" class="img-fluid aboutimg">
            </div>
...
<section>
  <div>
  <center><a href="sunlight.php" class="btn btn-success smoothscroll"> Sunlight</a>
 &nbsp; &nbsp; &nbsp;
 <a href="moisture.php" class="btn btn-success smoothscroll">Moisture</a></center>
</div>
<div>
  <p>&nbsp;</p>
</div>
